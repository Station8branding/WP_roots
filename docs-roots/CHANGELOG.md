...
#### 1.0.2.1 BitBrilliant February 13, 2014
* Updated Font Awesome 4.0.1

#### 1.0.2 BitBrilliant January 22, 2014
* Changed the footer.less to add 3 column widget areas
* Added footer.less, home.less, navbar.less
* Added base-page-home.php : removed sidebar and .main-inner
* Added page-home.php : removed the head hook and changed template name
